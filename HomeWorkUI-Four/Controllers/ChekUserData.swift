...
func chekUserData(name: UITextField, surname: UITextField, login: UITextField, password: UITextField) {
if name.text!.isEmpty || surname.text!.isEmpty || login.text!.isEmpty || password.text!.isEmpty {
